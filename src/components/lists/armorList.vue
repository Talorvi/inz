    ...
    showFeatureDialog(name) {
      ...
      axios
        ...
        .then(response => {
          ...
          this.armorClass.base = response.data[0].armorClass.base;
          this.armorClass.dexBonus = response.data[0].armorClass.dexBonus;
          this.armorClass.maxBonus = response.data[0].armorClass.maxBonus;
          this.stealthDisadvantage = response.data[0].stealthDisadvantage;
          this.weight = response.data[0].weight;
          this.strMinimum = response.data[0].strMinimum;
          this.dialog = true;
        })
        .catch(error => {
          if (error.response.status === 401) {
